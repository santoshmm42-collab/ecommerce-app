                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="assets/images/products/<?php echo htmlspecialchars($product['image']); ?>" 
                                                         ...
                                                         onerror="this.src='https://picsum.photos/seed/<?php echo urlencode($product['name']); ?>/60/60.jpg'">
                                                    <div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <span>Shipping:</span>
                                <span id="shipping-cost">₹<?php echo $subtotal > 999 ? '0.00' : '50.00'; ?></span>
                            </div>
                            ...
                            <?php else: ?>
                                <div class="alert alert-info mb-3">
                                    <i class="fas fa-truck me-2"></i>Add ₹<?php echo number_format(999 - $subtotal, 2); ?> more for free shipping!
                                </div>
                            <?php endif; ?>
